...
--4)
drop index anomalia_ts_idx;
drop index anomalia_tem_anomalia_traducao_idx;

create index anomalia_ts_idx 
on anomalia using btree (ts, tem_anomalia_traducao);
create index anomalia_tem_anomalia_traducao_idx 
on anomalia using hash (tem_anomalia_traducao);
